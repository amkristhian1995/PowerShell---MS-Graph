...
# correo: adeleV@kaam1995tec.onmicrosoft.com
# Obtener los datos de los usuarios
$MSGraphApi='https://graph.microsoft.com/v1.0/users/8074be8e-5a72-4890-bd76-db108769aa45'
$User=fnObtenerDatosMSGraph $MSGraphApi
$User